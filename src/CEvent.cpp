...
void CEvent::OnEvent(SDL_Event* Event)
{
    switch(Event->type) {
        ...
        case SDL_KEYUP: {
            OnKeyUp(Event->key.keysym.sym, static_cast<SDL_Keymod>(Event->key.keysym.mod));
            break;
        }
...
void CEvent::OnKeyDown(SDL_Keycode sym, SDL_Keymod mod)
{
    //Pure virtual, do nothing
}

void CEvent::OnKeyUp(SDL_Keycode sym, SDL_Keymod mod)
{
    //Pure virtual, do nothing
}
